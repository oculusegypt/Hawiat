...
function seedAll() {
  ...
  const slides = [
    {
      ...
      imageUrl: "/images/hero-riyadh-cleaning.jpg",
    ...
    },
    {
      ...
      imageUrl: "/images/hero-riyadh-postconstruction.jpg",
    ...
    },
    {
      ...
      imageUrl: "/images/hero-riyadh-majlis.jpg",
      ctaText: "تواصل معنا",
      order: 2,
      isActive: true,
      createdAt: now,
  ...
  const services = [
    {
      ...
      icon: "Sparkles",
      imageUrl: "/images/packages/package-01.png",
      order: 0,
      isActive: true,
    },
    {
  ...
  // --- Containers / Packages (باقات التنظيف بالرياض) ---
  const containers = [
    {
    ...
    },
    {
      ...
      pricePerDay: 750,
      imageUrl: "/images/packages/package-02.png",
      order: 1,
      isActive: true,
    },
    {
      ...
      pricePerDay: 900,
      imageUrl: "/images/packages/package-04.png",
      order: 2,
      isActive: true,
    },
    {
      ...
      pricePerDay: 250,
      imageUrl: "/images/packages/package-05.png",
      order: 3,
      isActive: true,
    },
    {
