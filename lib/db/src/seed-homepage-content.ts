...
export const homepageContent = {
  about: {
    ...
    description: "مؤسسة سبائك الماسة خيارك الأمثل في عالم تأجير الحاويات ونقل الأنقاض ومخلفات البناء والهدم والنفايات في مدينة الرياض. نقدم خدماتنا بأسطول حديث ومعايير سلامة بيئية صارمة وسرعة استجابة فائقة.",
    visionTitle: "رؤيتنا",
  ...
  sections: {
    ...
    contact: {
      ...
      whatsappText: "تواصل عبر واتساب (0555888767)",
      callText: "اتصال هاتفي مباشر (0580595555)",
    },
  },
};

const settings = [
  ["site_desc", "سبائك الماسة — الرائدون في تأجير حاويات المخلفات ونقل الأنقاض بالرياض منذ 2018. حاويات 6-12-20 ياردة. سرعة في الأداء - دقة في المواعيد . اتصل الآن: 0555888767"],
  ["company_name", "مؤسسة سبائك الماسة"],
  ["company_phone_call", "0580595555"],
  ["company_phone_whatsapp", "0555888767"],
  ["company_phones", JSON.stringify(["0555888767", "0580595555", "0581032000"])],
  ["company_footer_description", "مؤسسة سبائك الماسة، خيارك الأمثل في عالم تأجير الحاويات ونقل الأنقاض. نقدم خدماتنا بجودة عالية وأسعار تنافسية لنكون شركاء نجاحك في مشاريعك الإنشائية."],
...
console.log("Homepage content and section order updated for Sabaik Almasa.");