...
export function ServiceCard({
  ...
  return (
    <motion.div
      ...
      className="group relative bg-white border-2 border-slate-100 hover:border-secondary/50 rounded-3xl p-6 transition-all duration-300 hover:shadow-2xl hover:-translate-y-1.5 overflow-hidden flex flex-col justify-between"
    >
      {hasImages && (
