...
export default function PackagesPage() {
  ...
  const META_BY_CAT: Record<string, { title: string; desc: string; keywords: string; heading: string; sub: string; icon: any }> = {
    debris: {
      title: `حاويات الأنقاض ومخلفات البناء بالرياض (12 إلى 30 ياردة)${brandSuffix}`,
      desc: "تأجير حاويات الأنقاض ومخلفات الهدم والترميم بالرياض مقاسات 12 و15 و20 و30 ياردة مع التوصيل الفوري خلال ساعتين والتفريغ النظامي في المرادم المعتمدة.",
      keywords: "حاويات أنقاض بالرياض, تأجير حاويات مخلفات بناء, حاوية 12 ياردة, حاوية 20 ياردة, حاوية جامبو 30 ياردة, نقل أنقاض الرياض",
      heading: "حاويات الأنقاض ومخلفات البناء والهدم",
      sub: "مقاسات متنوعة (12، 15، 20، 30 ياردة) تناسب مشاريع الترميم والإنشاءات الكبرى مع توصيل وسحب فوري.",
      icon: Box
    },
    waste: {
      title: `حاويات النفايات والمكابس للمنشآت والمجمعات بالرياض${brandSuffix}`,
      desc: "تأجير حاويات النفايات 6 و10 ياردة ومكابس النفايات الكهربائية والهيدروليكية بعقود سنوية وتفريغ دوري منتظم للمطاعم والشركات والمجمعات بالرياض.",
      keywords: "حاويات نفايات الرياض, تأجير مكبس نفايات, مكابس نفايات كهربائية, حاوية 6 ياردة, حاوية 10 ياردة, تفريغ نفايات تجارية الرياض",
      heading: "حاويات النفايات والمكابس للمنشآت",
      sub: "حاويات 6 و10 ياردة ومكابس هيدروليكية متطورة مخصصة للمنشآت والمطاعم والمراكز التجارية مع جدول تفريغ منتظم.",
      icon: Truck
    },
    contract: {
    ...
    all: {
      title: `مقاسات وأسعار تأجير الحاويات وعقود بلدي بالرياض${brandSuffix}`,
      desc: "استعرض كافة أحجام ومقاسات حاويات الأنقاض (12 - 30 ياردة) وحاويات النفايات والمكابس وعقود النظافة المعتمدة بالرياض بأسعار تنافسية وتوصيل فوري.",
      ...
      sub: "اختر الحجم والفئة المناسبة لاحتياجات مشروعك أو منشأتك مع سرعة استجابة وتوصيل 24/7.",
      icon: Box
    }
  }
