...
export default function WhyUsWhatWe() {
  useDocumentSEO({
    title: "خدماتنا — شركة التنظيف | ماذا نقدم",
    description: "اكتشف جميع خدمات شركة التنظيف: تنظيف منازل وفلل، تنظيف بعد البناء، غسيل مجالس بالبخار، جلي رخام، وعقود نظافة دقيقة بالرياض.",
    keywords: "خدمات شركة التنظيف, ماذا نقدم, تنظيف منازل بالرياض, عقود نظافة الرياض",
    canonical: siteUrl("/why-us/what-we/"),
  })
