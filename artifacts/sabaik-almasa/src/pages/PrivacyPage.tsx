...
export default function PrivacyPage() {
  ...
  useDocumentSEO({
    ...
    description: "سياسة الخصوصية وحماية البيانات الشخصية لعملاء خدمات التنظيف وفق الأنظمة واللوائح المعمول بها في المملكة العربية السعودية.",
      ...
      <main className="container mx-auto max-w-4xl px-4 py-12 flex-1 space-y-8">
        <div className="bg-white rounded-3xl p-6 md:p-10 border border-gray-100 shadow-sm space-y-6 text-gray-700 leading-relaxed text-sm md:text-base">
          ...
          <div>
            ...
            <p>
              نحن في <strong>{siteSettings.companyName}</strong> نضع خصوصية وأمان بيانات عملائنا على رأس أولوياتنا. توضح هذه السياسة كيفية جمع واستخدام وحماية البيانات الشخصية التي تقدمها لنا عند استخدامك لموقعنا الإلكتروني أو طلب أي من باقات وخدمات التنظيف والتطهير الخاصة بنا.
            </p>
          </div>
