...
const FAQS: FAQItem[] = [
  {
    ...
    a: "نوفر 4 مقاسات رئيسية لحاويات الأنقاض: حاوية صغيرة 12 ياردة (400 ريال)، حاوية متوسطة 15 ياردة (450 ريال)، حاوية كبيرة 20 ياردة (500 ريال)، وحاوية جامبو 30 ياردة (700 ريال). السعر يشمل التوصيل، مدة بقاء 10 أيام، والنقل والتفريغ في المرادم الرسمية."
  },
  {
    category: "عام والتسعير",
