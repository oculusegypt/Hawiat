...
try {
  db.exec(`
    ...
    ('تأجير حاويات المخلفات والأنقاض بالرياض', 'حاويات 6 إلى 30 ياردة للمشاريع السكنية والتجارية مع سرعة في التوصيل والسحب 24/7', '/images/hero-1.jpeg', 'اطلب حاويتك الآن', 0, 1, datetime('now')),
    ('نقل مخلفات الهدم والبناء بأعلى معايير السلامة', 'أسطول شاحنات حديث مجهز لخدمة جميع أحياء الرياض بأسعار تنافسية', '/images/hero-2.jpeg', 'احجز موعد فوري', 1, 1, datetime('now')),
    ('عقود نظافة معتمدة ومكابس نفايات ذكية', 'حلول متكاملة للمنشآت والمطاعم والمصانع لتجديد الرخص وتفريغ منتظم', '/images/hero-3.jpeg', 'تواصل معنا', 2, 1, datetime('now'));
