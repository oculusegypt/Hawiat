...
const TESTIMONIALS = [
  ...
  },
  {
    ...
    content: "نتعامل مع مؤسسة السهم كلين منذ سنتين لنظافة عقاراتنا ومقراتنا بالرياض. خدمة لا تقبل المقارنة ودقة عالية في المواعيد والتطهير بالبخار.",
    rating: 5,
    is_active: 1
  },
  {
    ...
    content: "تعاملت مع شركات تنظيف عديدة بالرياض ولكن مؤسسة السهم كلين الأفضل على الإطلاق. سرعة في الاستجابة وجودة في غسيل المكيفات وجلي الرخام بالألماس.",
    rating: 5,
    is_active: 1
  },
  {
    ...
    content: "نثق في مؤسسة السهم كلين لجميع مجمعاتنا السكنية والتجارية بالرياض. عمالة مدربة، أجهزة بخار وتعقيم حديثة، وخدمة 24 ساعة. شركاء موثوقون حقاً.",
    rating: 5,
    is_active: 1
  }
];
