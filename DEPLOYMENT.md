...
# دليل نشر مؤسسة السهم كلين على Hostinger

## نظرة عامة

يتم نشر مشروع **مؤسسة السهم كلين - خدمات التنظيف بالرياض** على استضافة Hostinger كحزمة PHP + SQLite متكاملة ومكتفية ذاتياً بنسبة 100% بدون الحاجة لأي سيرفر Node.js خلفي.
...
- **قاعدة البيانات**: SQLite — ملف `data/sabaik.db` يُضمَّن في الأرشيف مع كافة بيانات الخدمات والمقالات والباقات وطلبات العملاء
...
│   └── .htaccess
└── data/
    └── sabaik.db         ← قاعدة البيانات المدمجة
```
